...
public class AcceptanceTest {
   ...
   @Test
    ...
    void row77() throws InterruptedException {
        ...
        assertThat(d2.findElement(By.xpath("/html/body/div/div[3]/div/div/div/div[2]/div/div[21]/div[1]")).getText(),is("Round has Ended, Player scores: player1 scored 1 Points, player2 scored 0 Points, player3 scored 86 Points, player4 scored 102 Points, Game has Ended, player2 is the Winner!"));
